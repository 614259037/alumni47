  ...
  <div class="container">
    <div class="row">
      <div class="col-md-5">
        ...
        <img src="img/<?php echo $result["img"]; ?>" alt="" width="250" height="250" srcset="">
        <br>
        <br>
      ...
      <div class="col-md-7">
        ...
        <div class="form-group col-md-3" style="margin-bottom: 0">
          <div class="form-group" align="left">
            ...
            <select class="form-control" id="Input2" name="fname" readonly>
              <option><?php echo $result["fname"]; ?></option>
        ...
        <div class="form-group col-md-5" style="margin-bottom: 0">
          <div class="form-group" align="left">
            ...
            <input type="text" class="form-control" id="Input3" placeholder="ชื่อ" name="cname" value="<?php echo $result["cname"]; ?> " readonly>
          </div>
        </div>
        <!--ชื่อ-->
        <div class="form-group col-md-4" style="margin-bottom: 0">
          <div class="form-group" align="left">
            ...
            <input type="text" class="form-control" id="Input3" placeholder="นามสกุล" name="lname" value="<?php echo $result["lname"]; ?>" readonly>
          </div>
        </div>
        <!--นามสกุล-->
        ...
        <div class="form-group col-md-5" style="margin-bottom: 0">
          <div class="form-group " align="left">
            ...
            <input type="text" class="form-control" id="Input3" placeholder="ชื่อเล่น" name="nname" value="<?php echo $result["nname"]; ?>" readonly>
          </div>
        </div>
        <!---ชื่อเล่น-->
        ...
        <div class="form-group col-md-5" style="margin-bottom: 0">
          <div class="form-group " align="left">
            ...
            <input type="date" class="form-control" id="Input3" name="dates" value="<?php echo $result["dates"]; ?>" readonly>
          </div>
        </div>
        <!--วันเกิด-->
        ...
        <div class="form-group col-md-3" style="margin-bottom: 0">
          <div class="form-group " align="left">
            ...
            <select class="form-control" id="Input2" name="years" value="" readonly>
        ...
        <div class="form-group col-md-12" style="margin-bottom: 0">
          <div class="form-group " align="left">
            ...
            <textarea name="caddress" id="form-control" rows="10" cols="60"readonly><?php echo $result["caddress"]; ?></textarea>
          </div>
        ...
        <div class="form-group col-md-3" style="margin-bottom: 0">
          <div class="form-group" align="left">
            ...
            <select class="form-control" id="Input2" name="province" value="" readonly>
      ...
      ?>
        ...
        <div class="form-group col-md-8" style="margin-bottom: 0">
          <div class="form-group col-md-12" align="left">
            ...
            <input type="text" class="form-control" id="form-control" placeholder="ตำแหน่งงาน" name="joblv" value="<?php echo $result["joblv"]; ?>" readonly>
          </div>
        </div>
        <!--ตำแหน่งงาน-->
        ...
        <div class="form-group col-md-8" style="margin-bottom: 0">
          <div class="form-group col-md-12" align="left">
            ...
            <input type="text" class="form-control" id="form-control" placeholder="ชื่อบริษัท" name="jobname" value="<?php echo $result["jobname"]; ?>" readonly>
          </div>
        </div>
        <!--ชื่อบริษัท-->
        <div class="form-group col-md-8" style="margin-bottom: 0">
          <div class="form-group col-md-12 " align="left">
            ...
            <textarea name="jobaddress" id="form-control" rows="10" cols="60"readonly><?php echo $result["jobaddress"]; ?></textarea>
          </div>
        ...
        <div class="form-group col-md-5" style="margin-bottom: 0">
          <div class="form-group col-md-12" align="left">
            <label for="Input2" style="margin-bottom: 0">จังหวัด</label>
            <select class="form-control" id="Input2" name="jobprov" value="" readonly>
              <option value="" selected><?php echo $result["jobprov"]; ?></option>
            </select>
          </div>
        </div>
        <!--จังหวัด-->
      ...
      ?>
        ...
        <div class="form-group col-md-8" style="margin-bottom: 0">
          <div class="form-group col-md-12" align="left">
            ...
            <input type="text" class="form-control" id="form-control" placeholder="เบอร์โทรศัพท์บ้าน" name="hphone" value="<?php echo $result["hphone"]; ?>" readonly>
          </div>
        </div>
        <!--เบอร์โทรศัพท์-->
        <div class="form-group col-md-8" style="margin-bottom: 0">
          <div class="form-group col-md-12" align="left">
            ...
            <input type="email" class="form-control" id="form-control" placeholder="อีเมล์" name="email" value="<?php echo $result["email"]; ?>" readonly>
          </div>
        </div>
        <!--อีเมล-->
        <div class="form-group col-md-8" style="margin-bottom: 0">
          <div class="form-group col-md-12" align="left">
            ...
            <input type="text" class="form-control" id="form-control" placeholder="facebook" name="facebook" value="<?php echo $result["facebook"]; ?>" readonly>
          </div>
        </div>
        <!--facebook-->
